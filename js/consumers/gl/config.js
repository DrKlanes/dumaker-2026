...
export const SCHEMA = [
	...
	['grunge.amount', 0, 1, 0.01], ['grunge.zoom', 1.2, 5, 0.05], ['grunge.wigglePos', 0, 1, 0.02],
	['grunge.wiggleRot', 0, 90, 1], ['grunge.fps', 1, 24, 1],
	['grunge.maskStart', 0, 3, 0.02], ['grunge.maskEnd', 0, 4, 0.02],
